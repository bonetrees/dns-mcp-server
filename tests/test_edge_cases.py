...
from dns_mcp_server.osint_tools import dns_propagation_check, dns_wildcard_check, dns_response_analysis
...
class TestNetworkFailures:
    ...
    async def test_partial_network_failure_bulk(self, mock_create_resolver):
        ...
        domains = ["test1.com", "test2.com", "test3.com", "test4.com", "test5.com", "test6.com"]
...
class TestIPv6Support:
    ...
    async def test_mixed_ipv4_ipv6_bulk_operations(self):
        ...
        result = await dns_bulk_reverse_lookup(
            ips=mixed_ips,
            timeout=5
        )
...
class TestResourceExhaustion:
    ...
    async def test_memory_intensive_operations(self):
        ...
        large_domain_list = [f"test{i}.example.com" for i in range(50)]  # Reduced from 100
...
class TestErrorRecovery:
    ...
    async def test_partial_failure_handling(self):
        ...
        result = await dns_query_all(
            domain="nonexistent-example-domain-12345.com",
            timeout=2
        )
...
class TestConfigurationEdgeCases:
    ...
    async def test_config_validation_in_tools(self):
        ...
        result = await dns_wildcard_check(
            domain="example.com",
            test_count=100,  # Should be clamped to max
            timeout=2
        )
